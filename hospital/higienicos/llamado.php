...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "INSERT INTO llamados (tipo, estado, tiempo_respuesta) VALUES ('$tipoLlamado', '$estadoLlamado', $tiempoRespuesta)";
    ...
    // Calcular el tiempo promedio de respuesta para cada tipo de llamado
    $sqlPromedioNormal = "SELECT AVG(tiempo_respuesta) AS promedio FROM llamados WHERE tipo = 'Normal'";
    ...
    $sqlPromedioEmergencia = "SELECT AVG(tiempo_respuesta) AS promedio FROM llamados WHERE tipo = 'Emergencia'";
